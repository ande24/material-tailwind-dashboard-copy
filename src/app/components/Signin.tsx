...
export default function Signin({ signupLink, forgotLink, options, terms, termsLink, subscribe}: SignInProps) {
  return (
    <div className="w-full lg:w-3/5 mt-24">
      ...
      <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
        ...
        <div className="flex items-center justify-between gap-2 mt-6">
            <div className={`${subscribe ? "flex" : "hidden"} items-center justify-start`}>
                <Checkbox
                    crossOrigin=""
          ...
          <Typography variant="small" className="font-semibold text-xs text-gray-900">
        ...
        >
          Not registered?
          <a href={signupLink} className="text-gray-900 font-semibold ml-1">
            Create account
          </a>
        </Typography>
      </form>
